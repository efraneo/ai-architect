...
from ai_architect.agente.herramientas_base import BaseTool, build_tool_descriptions
from ai_architect.agente.motor import InferenceEngine
from ai_architect.agente.prompts import (
    load_few_shot_exemplars,
    load_system_prompt_override,
)
from ai_architect.agente.registro import AgentRegistry
from ai_architect.agente.tipos import (
    Message,
    Role,
    ToolCall,
    ToolResult,
