...
from ai_architect.agente.skills.dependency import (
    DependencyCycleError,
    validate_dependencies,
)
from ai_architect.agente.skills.executor import SkillExecutor, SkillResult
from ai_architect.agente.skills.loader import discover_skills
from ai_architect.agente.skills.tool_adapter import SkillTool
...
class SkillManager:
    ...
    def __init__(
        ...
        *,
        ...
        if overlay_dir is None:
            ...
            try:
                from ai_architect.agente.seguridad import load_config
    ...
    def _load_overlays(self) -> None:
        ...
        """
        from ai_architect.agente.skills.overlay import SkillOverlayLoader
    ...
    def find_installed_paths(
        ...
        for root in roots:
            ...
            for candidate in root.rglob("*"):
                ...
                try:
                    from ai_architect.agente.skills.loader import load_skill_directory
    ...
    def remove(self, name: str, *, roots: list[Path] | None = None) -> list[Path]:
