...
if TYPE_CHECKING:
    ...
    from ai_architect.agente.mcp.client import MCPClient
    from ai_architect.agente.tipos import ToolSpec  # noqa: F401
...
def load_mcp_tools_from_config(
    ...
    *,
    ...
    """
    # ``enabled`` and ``servers`` come from ai_architect.agente.seguridad's
    ...
    # Imported lazily so that `ai_architect.agente.mcp.loader` can be imported
    ...
    from ai_architect.agente.mcp.adaptador import MCPToolProvider
    from ai_architect.agente.mcp.client import MCPClient
    from ai_architect.agente.mcp.transport import (
        StdioTransport,
