...
from ai_architect.agente.herramientas_base import ToolSpec
from ai_architect.agente.mcp.protocol import MCPError, MCPRequest, MCPResponse
from ai_architect.agente.mcp.transport import MCPTransport
