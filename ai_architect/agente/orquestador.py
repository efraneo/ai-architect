...
# Copyright de los autores de OpenJarvis. Archivo modificado para AI-architect
# (8 sep 2026): imports reescritos y acoplamientos a Rust/config sustituidos por piezas propias.
...
from ai_architect.agente.agente_base import AgentContext, AgentResult, ToolUsingAgent
...
from ai_architect.agente.registro import AgentRegistry
from ai_architect.agente.tipos import Message, Role, ToolCall, ToolResult
...
class OrchestratorAgent(ToolUsingAgent):
    ...
    def __init__(
        ...
        *,
        ...
        before_tool_call: Callable[[str, dict[str, Any]], bool] | None = None,
    ) -> None:
        super().__init__(
            engine,
            model,
    ...
    def _check_tool_allowed(self, tc: ToolCall) -> ToolResult | None:
    ...
    def _run_structured(
        ...
        **kwargs: Any,
        ...
        if self._system_prompt:
            ...
            from ai_architect.agente.herramientas_base import build_tool_descriptions

            sys_prompt = (
                "Eres un agente que resuelve tareas con herramientas. Usa las herramientas "
                "cuando hagan falta y termina con una respuesta clara en español.\n\n"
