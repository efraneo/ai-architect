...
from ai_architect.agente.tipos import Conversation, Message, Role, ToolResult
...
class BaseAgent(ABC):
    ...
    def _authorize_direct_operation(
        ...
        *,
        ...
        from ai_architect.agente.seguridad import authorize_secured_operation
    ...
    def _apply_persona(self, system_prompt: str | None) -> str | None:
...
class ToolUsingAgent(BaseAgent):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            from ai_architect.agente.guardia_bucles import LoopGuard, LoopGuardConfig
